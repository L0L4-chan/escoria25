...
static func set_default_values():
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.MASTER_VOLUME, 1.0)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.MUSIC_VOLUME, 0.8)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.SFX_VOLUME, 0.8)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.SPEECH_VOLUME, 0.9)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.FORCE_QUIT, false)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.LOG_FILE_PATH, "log")
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.LOG_LEVEL, 2)
	ESCProjectSettingsManager.set_setting(ESCProjectSettingsManager.FULLSCREEN,DisplayServer.WindowMode.WINDOW_MODE_WINDOWED )
