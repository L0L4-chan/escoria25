...
@export_node_path() var inventory_ui_container
...
func _ready():
	if has_node("FloatingInventory/panel/MarginContainer/ScrollContainer/Container"):  # Caso: UI de tipo mouse
		inventory_ui_container = "FloatingInventory/panel/MarginContainer/ScrollContainer/Container"
	...
	if items_ids_in_inventory.has(item_id):
		...
		if item_inventory_button.is_connected("mouse_left_inventory_item",
			...
			item_inventory_button.disconnect("mouse_left_inventory_item",
				escoria.inputs_manager._on_mouse_left_click_inventory_item)
		if item_inventory_button.is_connected("mouse_double_left_inventory_item",
