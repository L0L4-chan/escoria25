...
@export var dir_angles: Array = [Resource] : set = set_dir_angles
...
# the animation
@export var directions: Array = [Resource] : set =  set_directions
...
# the animation
@export var idles: Array = [Resource] : set =  set_idles

# Array containing the speak animations for each direction (in the
# order defined by dir_angles): scale parameter can be set to -1 to mirror
# the animation
@export var speaks: Array = [Resource] : set =  set_speaks
