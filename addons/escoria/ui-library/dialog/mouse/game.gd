...
func open_inventory():
	$ui/ui/HBoxContainer/inventory_ui.show_inventory()


func close_inventory():
	$ui/ui/HBoxContainer/inventory_ui.hide_inventory()
...
func hide_ui():
	$ui/ui.propagate_call("set_visible", [false], true)


func show_ui():
	$ui/ui.propagate_call("set_visible", [true], false)
	hide_main_menu()
