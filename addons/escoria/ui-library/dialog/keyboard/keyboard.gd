...
const input_map = preload("res://addons/escoria/ui-library/dialog/keyboard/input_map.gd")
var verbs_menu
var room_select
var tooltip
var inventory_ui
...
func _ready():
	super._ready()
	verbs_menu = $ui/Control/panel_down/VBoxContainer/HBoxContainer/VerbsMargin/verbs_menu
	tooltip = $ui/Control/panel_down/VBoxContainer/MarginContainer/tooltip
	inventory_ui = $ui/Control/panel_down/VBoxContainer/HBoxContainer/InventoryMargin/inventory_ui
	menu = $ui/main_menu
	pause = $ui/pause_menu

func _enter_tree():
	super._enter_tree()
	var room_selector_parent = $ui/Control/panel_down/VBoxContainer/HBoxContainer/MainMargin/VBoxContainer
...
func pause_game():
	if not pause.visible and not menu.visible:
		pause.reset()
		pause.set_save_enabled(escoria.save_manager.save_enabled)
		pause.show()
